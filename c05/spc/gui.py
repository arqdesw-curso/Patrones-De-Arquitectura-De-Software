...
def sentiment_analysis():
    ...
    url_tweet = urllib.urlopen('http://127.0.0.1:8083/api/v1/tweets?u=' + twitter_user)
    ...
    res_tweets = requests.post('http://127.0.0.1:8082/api/v1/text-analysis', json=tweets)
    # La siguiente url es para un servicio en la nube, pregunta al instructor(a) si el servicio está activo
